...
export default function Apps() {
	...
	return (
		<span className='ml-1 my-auto'>
			...
			<div className='fixed h-fit min-h-[10px] bg-stone-300 dark:bg-stone-800 bg-opacity-50 dark:bg-opacity-50 backdrop-blur-md rounded-2xl transition-all origin-top-right mt-5 w-56 right-0' id='menu' style={{ scale: '0' }}>
